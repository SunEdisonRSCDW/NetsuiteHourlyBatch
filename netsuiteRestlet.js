	...
	//	columns[13] = new nlobjSearchColumn('custentity_se_sales_channel');
	    ...
	    if(searchresults) 
	    {
			...
			//		result.custentity_se_sales_channel = searchresult.getText('custentity_se_sales_channel');
					...
					result.custentity323 = searchresult.getText('custentity323'); //Lead Lost
					result.custentity_sales_agent = searchresult.getText('custentity_sales_agent'); //Sales Agent
					result.custentity214 = searchresult.getText('custentity214'); //Assigned to partner sales person
...
function getSiteData(timestamp,lastRecordId){
	...
	filters[0] = new nlobjSearchFilter('lastmodified', 'null', 'onOrAfter', timestamp);
        ...
        columns[54] = new nlobjSearchColumn('custrecord_dsg_target_install_date');
        columns[55] = new nlobjSearchColumn('custrecord_dsg_act_install_comm_date');
